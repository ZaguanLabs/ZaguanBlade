...
pub use store::{
    ...
    RelationshipObservationKind, RelationshipTypeStats, SemanticAnchor, SemanticAnchorResult,
    SymbolReference, SymbolStore, SymbolStoreError, UnresolvedRelationshipTarget,
};
